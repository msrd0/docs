...
sourcesIndex["libwebp_sys"] = {"name":"","files":["decode.rs","demux.rs","encode.rs","lib.rs","mux.rs","mux_types.rs","types.rs"]};
...
sourcesIndex["webp_animation"] = {"name":"","files":["decoder.rs","encoder.rs","encoder_config.rs","frame.rs","lib.rs","webp_data.rs"]};
createSourceSidebar();
